...
class order_form(FormAction):
    ...
    def submit(self,
        ...
        message = "your order is {} {} {}".format(tracker.get_slot("order"),tracker.get_slot("item"),tracker.get_slot("quantity"))
        global order
        order = []
        
        dispatcher.utter_message(message)

        return [SlotSet("item",None),SlotSet("quantity",None),SlotSet("order",None)]
